...
export default function ViewPage() {
    ...
    useEffect(() => {
        (async () => {
            ...
            try {
                // Fetch generation content and metadata from single endpoint
    ...
    return (
        <div className="min-h-screen bg-gray-50">
                            ...
                            {isEditing ? (
                                <>
                                    <button
                                        ...
                                        disabled={saving}
                                        className="px-4 py-2 text-sm text-gray-700 hover:text-gray-900 rounded-lg hover:bg-gray-100 transition-colors disabled:opacity-50"
                                    >
                                        Cancel
                                    </button>
                                    <button
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 py-4"></div>
            {/* CONTENT */}
            {isEditing ? (
                ...
                <div className="bg-white rounded-xl shadow-sm border lg:px-8 border-gray-200 overflow-hidden">
